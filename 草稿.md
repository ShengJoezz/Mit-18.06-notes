$$A=\begin{bmatrix}\alpha_1^T\\a_2^T\\\cdots\\\alpha_n^T\end{bmatrix}B=\begin{bmatrix}\beta_1&\beta_2\cdots\beta_n\end{bmatrix}=\begin{bmatrix}\alpha_1^T\beta_1&\alpha_2^T\beta_2\cdots\alpha_n^T\beta_n\\\end{bmatrix}$$

左消去律的证明:
$$Bx=0\rightarrow ABx=0$$
$$ABx=0\rightarrow 考虑Bx=y\rightarrow Ay=0由于A列满秩\rightarrow y=0\rightarrow Bx=0$$
即说明$ABx=0与Bx=0$等价，说明在$A$列满秩的时候，$ABx=0$与$Bx=0$等价

$$A=\begin{bmatrix}1&0&0\\0&1&1\end{bmatrix}r(A)=2=m$$
$$B=\begin{bmatrix}1&3\\2&1\\-1&2\end{bmatrix}r(B)=2\ \ AB=\begin{bmatrix}1&3\\1&3\end{bmatrix}r(AB)<r(B)但是r(A)=m$$
